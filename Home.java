...
public class Home extends JFrame implements ActionListener {
    ...
    public Home(String username) {
        ...
        Image img = Toolkit.getDefaultToolkit().getImage("resources1/gallery_bg.png");
        if (img == null) {
            ...
            // Header label
            JLabel header = new JLabel("Inspira: Digital Art Gallery for Emerging Artists");
...
//            bgLabel.add(aiRecommendations);
    ...
    private JPanel createGifPanel() {
        ...
        for (int i = 1; i <= 9; i++) {
            String gifPath = "resources1/gif" + i + ".gif"; // Adjust path to your GIFs
